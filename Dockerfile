...
RUN .venv/bin/ruff check src tests scripts deploy/live-secrets.py && .venv/bin/ruff format --check src tests scripts deploy/live-secrets.py && .venv/bin/pytest -q
USER pm
